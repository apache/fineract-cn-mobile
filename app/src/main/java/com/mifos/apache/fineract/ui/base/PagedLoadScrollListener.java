...
public abstract class PagedLoadScrollListener extends RecyclerView.OnScrollListener {
    ...
    public interface LoadCompleteNotifier {
        ...
        /**
         * Call to notify that a load has completed, but no new items were present, and none
         * will be
         * forthcoming.
         */
    ...
    public void onScrolled(RecyclerView view, int dx, int dy) {
        ...
        if (totalItemCount < previousTotalItemCount) {
            ...
            int lastVisibleItemAdapterPosition = layoutManager.getViewAdapterPosition(
                    lastVisibleItem);
    ...
    /**
     * Override this to handle loading of new data. Each time new data is pulled in, the page
